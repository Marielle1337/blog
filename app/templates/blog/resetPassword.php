...
<?php $this->start('main_content') ?>
    ...
    <form action="#" method="post">
        <label for="password">Nouveau mot de passe :
            <input id="password" type="password" name="new_pass" placeholder="Nouveau mot de passe *">
        </label>
        ...
        <label for="password2">Confirmez le mot de passe : 
            <input id="password2" type="password" name="password2" placeholder="Réécrivez mot de passe *">
        </label>
